    ...
    <div className="grid grid-cols-4 gap-3 mb-4">
      <div className="bg-slate-50 rounded-lg p-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-medium text-slate-700">Uren</span>
        </div>
      ...
      <div className="bg-slate-50 rounded-lg p-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-medium text-slate-700">Waarde</span>
        </div>
        <div className="font-semibold text-slate-900">
      ...
      <div className={`rounded-lg p-3 ${nextDeadline ? 'bg-orange-50' : 'bg-slate-50'}`}>
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className={`font-medium ${nextDeadline ? 'text-orange-700' : 'text-slate-700'}`}>Deadline</span>
        </div>
        {nextDeadline ? (
          <>
            <div className={`font-semibold ${getDeadlineColor(nextDeadline.due_date)}`}>
