...
export const UniqueLayoutSelector = ({ 
  ...
  const renderUniquePreview = (layout: UniqueLayoutTemplate) => {
    const baseClasses = `aspect-[3/2] bg-gradient-to-br ${layout.preview.backgroundColor} rounded-md mb-2 flex flex-col relative overflow-hidden border`;
    
    return (
      <div className={baseClasses}>
        {/* Header based on layout style */}
        <div className="absolute top-0 left-0 right-0 p-1.5">
          {layout.preview.headerPattern === 'gradient-header' && (
            <div className="bg-gradient-to-r from-blue-600 to-blue-500 h-4 rounded-sm flex items-center px-1.5">
              <div className="w-2 h-1 bg-white/80 rounded-sm mr-1"></div>
          ...
          {layout.preview.headerPattern === 'centered-formal' && (
            <div className="border border-gray-700 bg-white p-1 text-center">
              ...
              <div className="w-6 h-0.5 bg-gray-700 mx-auto mt-0.5"></div>
            </div>
          )}
          ...
          {layout.preview.headerPattern === 'artistic-header' && (
            <div className="bg-gradient-to-br from-purple-600 via-purple-500 to-purple-400 p-1.5 rounded-lg">
          ...
          {layout.preview.headerPattern === 'business-header' && (
            <div className="border-l-2 border-green-600 bg-white pl-1.5 py-0.5">
        ...
        <div className="flex-1 mt-6 px-1.5 pb-1.5">
          ...
          {layout.preview.layoutStructure === 'minimal-grid' && (
            <div className="grid grid-cols-2 gap-1 h-full">
              <div className="space-y-0.5">
                <div className="h-0.25 bg-black rounded"></div>
                <div className="h-0.25 bg-gray-400 rounded"></div>
              </div>
              <div className="space-y-0.5">
                <div className="h-0.25 bg-gray-300 rounded"></div>
                <div className="h-0.25 bg-gray-200 rounded"></div>
              </div>
            </div>
          )}
          ...
          {layout.preview.layoutStructure === 'creative-flow' && (
            <div className="relative h-full">
              ...
              <div className="absolute top-2 right-0 w-1/3 h-1 bg-purple-300 rounded"></div>
          ...
          {layout.preview.layoutStructure === 'traditional' && (
            <div className="border border-green-200 p-1 h-full">
              <div className="space-y-0.5">
